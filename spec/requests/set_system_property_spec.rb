...
describe Fishbowl::Requests do
  describe "#set_system_property" do
    before :each do
      mock_tcp_connection
      mock_login_response
    ...
    it "sends proper request" do
      ...
      Fishbowl::Requests.set_system_property(valid_options)
    ...
    def expected_response
      Nokogiri::XML::Builder.new do |xml|
        xml.response {
          xml.SetSystemPropertyRs(statusCode: '1000', statusMessage: "Success!") {
            #TODO figure out what goes here!
          }
        }
      end
