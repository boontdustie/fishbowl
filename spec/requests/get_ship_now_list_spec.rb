...
describe Fishbowl::Requests do
  describe "#get_ship_now_list" do
    ...
    it "sends proper request" do
      ...
      Fishbowl::Requests.get_ship_now_list("SLC", "UPS")
    ...
    def expected_response
      Nokogiri::XML::Builder.new do |xml|
        xml.response {
          xml.GetShipNowListRs(statusCode: '1000', statusMessage: "Success!") {
