...
describe Fishbowl::Requests do
  describe "#get_transfer_order_list" do
    before :each do
      mock_tcp_connection
      mock_login_response
    ...
    it "sends proper request" do
      ...
      Fishbowl::Requests.get_transfer_order_list(5)
    ...
    def expected_response
      Nokogiri::XML::Builder.new do |xml|
        xml.response {
          xml.GetTransferOrderListRs(statusCode: '1000', statusMessage: "Success!") {
