...
describe Fishbowl::Requests do
  describe "#load_transfer_order" do
    before :each do
      mock_tcp_connection
      mock_login_response
    ...
    it "sends proper request" do
      ...
      Fishbowl::Requests.load_transfer_order(1)
    ...
    def expected_response
      Nokogiri::XML::Builder.new do |xml|
        xml.response {
          xml.LoadTransferOrderRs(statusCode: '1000', statusMessage: "Success!") {
