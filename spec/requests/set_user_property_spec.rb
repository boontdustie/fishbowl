...
describe Fishbowl::Requests do
  describe "#set_user_property" do
    ...
    it "sends proper request" do
      ...
      Fishbowl::Requests.set_user_property(valid_options)
    ...
    def expected_response
      Nokogiri::XML::Builder.new do |xml|
        xml.response {
          xml.SetUserPropertyRs(statusCode: '1000', statusMessage: "Success!") {
            #TODO figure out what goes here!
          }
        }
      end
